...
export default function SupplierAdd() {
  ...
  return (
    <div className="max-w-xl">
      <h1 className="ptitle">Supplier / Ledger Add <span className="kbd ml-2">F7</span></h1>
      <div className="card grid grid-cols-2 gap-3">
        <label className="lbl col-span-2">Account Name*<input value={f.accountName} onChange={(e) => set('accountName', e.target.value)} autoFocus /></label>
        ...
        <label className="lbl">City<input value={f.city} onChange={(e) => set('city', e.target.value)} /></label>
        <label className="lbl">Phone<input value={f.phone} onChange={(e) => set('phone', e.target.value)} /></label>
